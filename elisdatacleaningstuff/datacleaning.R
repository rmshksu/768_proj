...
# File PATHS
pop.file.path <- "F:/Data/Nueva carpeta/BayesianClassProject/annual.csv"
overdose.counts.file.path <- "F:/Data/Nueva carpeta/BayesianClassProject/DOMBS_2020.csv"
fredGDPSTATE.file.path <- "F:/Data/Nueva carpeta/BayesianClassProject/fredGDPSTATE.R"
fredPCPISTATE.file.path <- "F:/Data/Nueva carpeta/BayesianClassProject/fredPCPISTATE.R"
fredHOWNSTATE.file.path <- "F:/Data/Nueva carpeta/BayesianClassProject/fredHOWNSTATE.R"
fredGCT1502STATE.file.path <- "F:/Data/Nueva carpeta/BayesianClassProject/fredGCT1502STATE.R"
fredTOTLTAXSTATE.file.path <- "F:/Data/Nueva carpeta/BayesianClassProject/fredTOTLTAXSTATE.R"
